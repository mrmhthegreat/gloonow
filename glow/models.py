...
class AppReview(models.Model):
    ...
    message=models.CharField(max_length=5000, null=True,blank=True,default='')
...
class AboutusUs(models.Model):
    ...
    text1_heading=models.CharField(max_length=5000, null=True,blank=True,default='')
    text1_description=models.CharField(max_length=5000, null=True,blank=True,default='')
    text1_description2=models.CharField(max_length=5000, null=True,blank=True,default='')
    text1_images=models.ImageField(upload_to='media/about',)
    text2_heading=models.CharField(max_length=5000, null=True,blank=True,default='')
    text2_description=models.CharField(max_length=5000, null=True,blank=True,default='')
    text2_description2=models.CharField(max_length=5000, null=True,blank=True,default='')
